const SW_VERSION = 'sw-v16-34_sia_zoom_reuse_startup_guard';
...
const OFFLINE_ONLINE_FALLBACK_KEY = 'offlineOnlineFallback';const SW_VERSION = 'sw-v16-35_sia_zoomout_yield';
const APP_VERSION = 'v16.35';
const SIA_DATA_REVISION = '15.69';
const SIA_DATA_URL = './sia.js';
const SIA_DATA_CACHE = `npf-q400-sia-data-${SIA_DATA_REVISION}`;
