...
const APP_CACHE_NAME = 'communes-app-cache-v203'; // Version 7.3 stable
const DATA_CACHE_NAME = 'communes-data-cache-v203';
const TILE_CACHE_NAME = 'communes-tile-cache-v203'; // Pour le cache de navigation normal
