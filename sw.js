...
// MODIFICATION ICI 👇
const APP_CACHE_NAME = 'communes-app-cache-v28'; // Version incrémentée
const TILE_CACHE_NAME = 'communes-tile-cache-v9';
const DATA_CACHE_NAME = 'communes-data-cache-v6'; // Pas besoin de changer, les données n'ont pas changé
